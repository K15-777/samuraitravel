...
public class HouseController {
                       ...
                       Model model) 
    {
        ...
        if (userDetailsImpl != null) {
            ...
            if (reviewRepository.findFirstByHouseAndUser(house, user) != null) {
        ...
        model.addAttribute("hasUserReviewed", hasUserReviewed); // 判定結果を画面へ渡す
        model.addAttribute("favorite", favorite);     // お気に入りデータ（解除時のID特定用）
        model.addAttribute("isFavorite", isFavorite); // 登録状態のフラグ
