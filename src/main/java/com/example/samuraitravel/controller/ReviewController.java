...
public class ReviewController {
	...
	public ReviewController(HouseRepository houseRepository, ReviewService reviewService, ReviewRepository reviewRepository) {
			...
			Model model)
	{
		...
		ReviewEditForm reviewEditForm = new ReviewEditForm(review.getId(), review.getEvaluation(), review.getReviewContents());
